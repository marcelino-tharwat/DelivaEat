...
class _SignUpViewState extends State<SignUpView> {
  ...
  // MODIFIED: Add a check for _isCompressing to the button
Future<void> _signUp() async {
  ...
  if (_selectedRoleKey == 'rider') {
    // That's it! Just call the cubit and pass the FILE objects.
    // The UI's job is done. It doesn't need to know about uploading.
  ...
  await cubit.merchantRegister(
    context: context,
    // NEW: Pass the basic info from the text controllers
    name: _nameController.text.trim(),
    email: _emailController.text.trim(),
    password: _passwordController.text,
    ...
    address: _address,
    location: location,
    avatarUrl: null, // Cubit will handle the placeholder
  );
}
}
        ...
        builder: (context, state) {
          ...
          return SafeArea(
            child: SingleChildScrollView(
              ...
              child: Stack( // NEW: Use a stack to show a global compressing indicator
                children: [
                  // Your main content
                  Column(
                    children: [
                              ...
                              SizedBox(
                                ...
                                child: AbsorbPointer(
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      Opacity(
                                        opacity: isLoading || _isCompressing ? 0.6 : 1,
                                        child: AppButton(
                                          onPressed: _signUp,
  ...
  Widget _buildRoleSpecificFields() {
    ...
    if (_selectedRoleKey == 'merchant') {
      return MerchantFieldsSection(
        ...
        selectedBusinessType: _selectedBusinessType ?? l10n.business_type_restaurant,
